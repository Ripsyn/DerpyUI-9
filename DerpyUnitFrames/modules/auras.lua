...
local auraIcon = function(icons, button)
	...
	button:SetHeight(icons.icon_height)
...
local nn_help = function(aura,prefix,var)
	...
	aura.num_cd_pos_x = var[prefix.."_num_cd_pos_x"] /10
	aura.num_cd_pos_y = var[prefix.."_num_cd_pos_y"] /10
	aura.num_cd_size =	var[prefix.."_num_cd_size"]
	aura.count_size = 	var[prefix.."_count_size"]
	aura.count_pos =	var[prefix.."_count_pos"]	
	aura.count_pos_x =	var[prefix.."_count_pos_x"] /10
	aura.count_pos_y = 	var[prefix.."_count_pos_y"] /10
	aura.icon_height = floor(aura.size*.875+.5)
	aura['spacing-y'] = 4-(aura.size-aura.icon_height) -- don`t touch that
end
