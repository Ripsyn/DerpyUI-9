...
local level = function(self)
	...
	local ri  = self.level_:CreateTexture(nil, "OVERLAY")
	ri:SetSize(26,26)
	ri:SetAlpha(.75)
	ri:SetPoint("CENTER",self.level_,"TOP",0,-2)
