...
Minimap:SetScale(1)
Minimap:SetPlayerTexture(M.media.path.."MinimapArrow.blp")
...
QueueStatusMinimapButton:SetPoint("BOTTOMRIGHT", mP, -1, 4)
...
local StreamingIcon = StreamingIcon	
...
-- MiniMapLFGFrame.SetPoint = M.null
...
local m_coord_text = M.setcdfont(m_coord,15,nil,nil,"CENTER")
	m_coord_text:SetPoint("TOPLEFT",2,0)
	m_coord_text:SetPoint("BOTTOMRIGHT",-1,0)

M.mod_minimap = function()	
...
do
	...
	abc:SetScript("OnUpdate",function(self,t)
		ela = ela - t
