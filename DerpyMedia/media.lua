...
M["media"].font_lang = (M.L == "ruRU" and mediapath..[=[altmono.ttf]=]) -- RU
	or (M.L == "koKR" and [=[Fonts\2002.TTF]=]) -- KR
	or (M.L == "zhTW" and [=[Fonts\bLEI00D.ttf]=]) -- TW
	or (M.L == "zhCN" and [[Fonts\ZYKai_C.TTF]]) -- CN
	or M["media"].font -- EN
