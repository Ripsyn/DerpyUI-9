...
local offset_f
local _font = M["media"].fontn_lang

local SetFont = function(obj, font, size, style)
...
M.addlast(function()
	...
	SetFont(NumberFont_Outline_Huge,            true, 28, "THICKOUTLINE")
	...
	SetFont(ZoneTextString,                     true, 100, "OUTLINE")
	...
	SetFont(SystemFont_OutlineThick_WTF,		true, 100, "THINOUTLINE")
	SetFont(SystemFont_OutlineThick_WTF,		true, 100, "THINOUTLINE")
	...
	SetFont(GameFont_Gigantic,					true, 100)
